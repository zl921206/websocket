...
public class WebSocketServiceImpl implements WebSocketService {
    ...
    @Override
    public void disconnect(Integer sysType, Long userId, String userType){
        try {
            deleteUserChannel(SysChannelMap.getValue(sysType).get(StringUtils.getUserIdentity(userId, userType)));
        } catch (Exception e){
            e.printStackTrace();
